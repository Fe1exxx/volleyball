...
**Добро пожаловать на мой проект по воллейболу!**, на этот проект ушло (и ещё уйдёт) много времени, используется в качестве образовательных целях, в будущем может использоваться в проде). Ну а для начала представлюсь: 
...
| **Сборка**      | Vite |
| **Работа с данными** | `fetch`, `async/await`, `zustand`, обработка ошибок, валидация входных данных |
| **Безопасность**| Защита от XSS через экранирование, `unit` тесты - vitest |
